...
function lowestRevenues(name) {
    fetch(url+ 'publisher/'+ name+ '/revenue/?sort=amount,asc',{
        method: 'get',
        headers: {
            'x-auth-token': getCurrentUser()
        }
...
function highestRevenues(name) {
    fetch(url+ 'publisher/'+ name+ '/revenue/?sort=amount,desc',{
        method: 'get',
        headers: {
            'x-auth-token': getCurrentUser()
        }
